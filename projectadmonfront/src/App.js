...
function App() {
  const apiRoute = "http://165.227.127.68:8080/projectAdmon/";
    ...
    reader.onload = function (evt) {
      ...
      if (!pipe) {
        Swal.fire({
          icon: "error",
          title: "Oops...",
          text: "El delimitador es requerido",
        });
      ...
      if (!privateKey) {
        Swal.fire({
          icon: "error",
          title: "Oops...",
          text: "La llave privada es requerida",
        });
        return;
      }
  ...
  const downloadFile = (fileName, content, fileType) => {
    ...
    const mimeType =
      fileType === "JSON" ? "application/json" : "application/xml";
        ...
        <div class="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-2">
          <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-2 text-lg leading-8 text-gray-600">
                Convierte tus archivos TXT a JSON o XML y encripta la tarjeta
              </p>
            </div>
            <form
              action="#"
          ...
          <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-2 text-lg leading-8 text-gray-600">
                Convierte tus archivos JSON o XML a TXT y desencripta la tarjeta
              </p>
            </div>
            <form
              action="#"
